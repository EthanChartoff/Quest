...
typedef struct SEMANTIC_RULE_STRUCT {
    ...
    void (*definition)(stack_T *astack, parse_tree_node_T *tree, symbol_table_T *sym_tbl);   // definition of rule, for example. E.val = E1.val + T.val, implemented by function ptr
} semantic_rule_T;
