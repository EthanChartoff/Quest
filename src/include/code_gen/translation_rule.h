...
typedef struct TRANSLATION_RULE_STRUCT {
    symbol_T *symbol;
    void (*translation)(ast_node_T *ast, stack_T *astack, register_T **regs);
} translation_rule_T;

translation_rule_T *init_translation_rule(symbol_T *symbol, void (*translation)(ast_node_T *ast, stack_T *astack, register_T **regs));
